...
with DAG(
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f"curl -u '{METEO_USER}:{METEO_PASSWORD}' {weather_url} >  {path_to_local_home}/{dataset_file}"
    )
    ...
    download_dataset_task >> format_to_parquet_task >> upload_to_gcs_task